export default {
  ...
  expenses: {
    ...
    balanceHistorySubtitle: 'Sehen Sie, wie Ausgaben und Ausgleiche Ihren Kontostand verändert haben.',
    balanceHistoryDebtLoan: 'Ihre Schulden: %{debt} · Ihnen geschuldet: %{loan}',
    balanceHistoryOweShort: 'Schuld',
    balanceHistoryOwedShort: 'Forderung',
    balanceHistoryNoData: 'Noch keine Kontostand-Änderungen',
    balanceHistoryNoDataDescription: 'Fügen Sie Ausgaben hinzu oder gleichen Sie aus, um Verlauf zu sehen.',
    balanceHistoryYouCovered: 'Für andere übernommen: %{amount}',
    balanceHistoryYourShare: 'Ihr Anteil: %{amount}',
  ...
  chores: {
    ...
    rotationMembersHint: 'Deaktiviere Personen, die an dieser Aufgabe nicht mitmachen.',
    rotationOrderHint: 'Erste Person Woche 1, zweite Woche 2, dann wiederholt es sich.',
    startDate: 'Startdatum',
    startDateHint: 'Rotationen laufen Montag–Sonntag. Wähle die erste Woche zum Start.',
    ...
    noChoresOnDay: 'Keine Termine oder Aufgaben',
    currentPeriod: 'Aktueller Zeitraum',
    overdue: 'Überfällig',
    giveTo: 'Abgeben an…',
    swapWeek: 'Meine Woche an %{name} geben',
    overrideConfirm: 'Diesen Zeitraum an %{name} geben?',
    upcoming: 'Als Nächstes: %{list}',
  },
